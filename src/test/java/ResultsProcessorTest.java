...
public class ResultsProcessorTest {
    ...
    public void testEmptyResultsCollection() {
        ...
        assertThrows(IllegalArgumentException.class, () -> new ResultsProcessor(Collections.emptyList()));
    }
    ...
    public void testInvalidLimit() {
        ...
        assertThrows(IllegalArgumentException.class, () -> processor.getFastest(Gender.MALE, Distance.TEN_KM, 0));

        assertThrows(IllegalArgumentException.class, () -> processor.getFastest(Gender.MALE, Distance.TEN_KM, -1));
    }

    @Test
    public void testGetFastest() {
        // Создаем коллекцию с результатами
        final var processor = getResultsProcessor();
        ...
        assertEquals("Emily White", fastestWomen.getFirst().person().name());
    }

    private static ResultsProcessor getResultsProcessor() {
        List<Result> results = List.of(
                new Result(new Person("John Smith", Gender.MALE), Distance.TEN_KM, Duration.ofSeconds(30 * 60 + 29)),
        ...
        // Создаем ResultsProcessor
        return new ResultsProcessor(results);
    }
}